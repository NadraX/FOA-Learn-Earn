...
CREATE TABLE Cerinte_licenta (
    ...
    optiune_test_scris varchar2(20)  NULL,
...
CREATE TABLE Date_personale_licenta (
    ...
    etaj varchar2(10)  NULL,
    apartament varchar2(5)  NULL,
	...
	stare_sociala_speciala  varchar2(50)  NULL,
...
CREATE TABLE Date_personale_preadmitere (
    ...
    data_eliberarii date  NULL,
    data_expirarii date  NULL,
    institutie_liceu varchar2(140)  NULL,
...
CREATE TABLE Date_preg_anterioara_licenta (
    ...
    nr_diploma_bac varchar2(10)  NULL,
    ...
    denumire_institutie_fac varchar2(100)  NULL,
    denumire_alta_facultate varchar2(100)  NULL,
    ...
    denumire_institutie_abs varchar2(100)  NULL,
    denumire_facultate_abs varchar2(100)  NULL,
...
CREATE TABLE Date_preg_anterioara_master (
    ...
    judet_fac varchar2(35)  NULL,
    denumire_institutie_fac varchar2(100)  NULL,
    denumire_facultate varchar2(100)  NULL,
    ...
    diplo_licenta_nr varchar2(10)  NULL,
    ...
    absolvent_denumire_instit varchar2(100)  NULL,
    absolvent_denumire_facult varchar2(100)  NULL,
