								...
								<div id="cid_10" class="form-input jf-required">
									...
									<div data-wrapper-react="true">
										<span class="form-sub-label-container" style="vertical-align:top;">
											...
											Upload aici: <input type="file" name="fileToUpload" id="fileToUpload">
												<?php
													$target_dir = "uploads/";
      ...
      if($vLicenta_CNP !=0 and $vLicenta_Apartament != 0 and $vLicenta_Bloc != 0 and $vLicenta_Buletin_Eliberat_De != 0 and $vLicenta_Cod_Postal !=0
		  ...
		  and $vLicenta_Strada !=0 and $vLicenta_Telefon !=0 and $vLicenta_Tip_Buletin !=0 ){
            ...
            error_reporting(E_ALL);
		  	$statement_id = oci_parse($connection, "select count(*) as NUMBER_OF_ROWS from date_personale_candidat");
		 
			oci_define_by_name($statement_id, 'NUMBER_OF_ROWS', $v_id);

		  	oci_execute($statement_id);

		  	oci_fetch($statement_id);
            ...
            :cod_postal_domiciliu)");
		  	...
		  	oci_bind_by_name($statement1, ':id', $v_id);
