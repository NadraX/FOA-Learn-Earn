					...
					<div class="formular2">
						...
						<ul>
							<li class="form-line" data-type="control_fullname" id="id_1">
								<label class="form-label form-label-left form-label-auto" id="label_1"  style="color: #3488CB; font-size:large"> I. Informa&#355;ii   generale <span class="info-box">!<span class="info-box__content">În măsura în care este posibil, datele personale se vor completa din buletin </span></span></label>
								...
								<div  class="form-input jf-required cid_1">
									...
									<br>
									 ...
									 <div class="form-input jf-required cid_1">
                                <div style="width: 59%; margin:0; padding:0">
                                    <span class="form-sub-label-container" id="liceu" style="vertical-align:top;margin:0; padding:0">
										<input type="text" class="form-dropdown form-address-country liceu" name="liceu" id="input_3_country" data-component="country" list="licee">
                                            <datalist id="licee">
...
<option value="LICEUL &quot;SIMION MEHEDINŢI&quot; VIDRA">
                                ...
                                <div style="width: 40%; margin:0; padding:0">
                                    <span class="form-sub-label-container gen" style="vertical-align:top;margin:0; padding:0">
                                        <select class="form-dropdown form-address-country middle_1" name="proba" data-component="country">
                                            <option value="Matematica">Matematic&#259;</option>
                                            <option value="Informatica">Informatic&#259; C/C++</option>
                                        </select>
                            ...
                            <li class="form-line form-line-column form-col-1" data-type="control_birthdate" id="id_10">
								<label class="form-label form-label-left form-label-auto" id="label_10"  style="color: #3488CB; font-size:large">II. Data na&#351;tere</label>
							...
							<li class="form-line" data-type="control_address" id="id_3">
								<label class="form-label form-label-left form-label-auto" id="label_3" style="color: #3488CB; font-size:large"> III. Adresa dvs. </label>
								<div class="form-input jf-required cid_1">
							...
							<li class="form-line form-line-column form-col-1" data-type="control_phone" id="id_6" style="width:50%; margin-right:50px">
								<label class="form-label form-label-left form-label-auto" id="label_6"   style="color: #3488CB; font-size:large">IV. Contact </label>
                            ...
                            <li>
									...
									<div data-wrapper-react="true">
										<span class="form-sub-label-container" style="vertical-align:top;">
											<label class="form-label form-label-left form-label-auto" id="label_9" for="input_9" style="color: #3488CB; font-size:large">V. Uploadare diplome, certificate (format pdf)</label>
