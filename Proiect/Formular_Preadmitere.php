...
<html class="supernova">
	...
	<head>
		...
		<title>Examen preadmitere</title>
	</head>
				...
				<div class="">
					...
					<div class="formular2">
						...
						<ul>
							...
							<li class="form-line" data-type="control_fullname" >
								<label class="form-label form-label-left form-label-auto" id="label_1"  style="color: #3488CB; font-size:larger"> III. Studiile preuniversitare unde sunteţi înmatriculat </label>
								<br>
								<div class="form-input jf-required cid_1">
									<div>
