...
function Footer()
{
    ...
    // oci_bind_by_name($s, ":in_romana", $in_romana, 100);
	 ...
	 oci_bind_by_name($s, ":diploma_echiv_studii_copie", $diploma_echiv_studii_copie, 100);
	...
	$pdf->Cell(50, 20, 'Studii universitare de LICENTA - forma de invatamant:', 0, 0, 'C');
	
	$pdf->Ln(5);
	$pdf->Cell(76.5);
	$pdf->SetFont('Arial','I',9);
	$pdf->Cell(50, 20, 'invatamant cu frecventa; invatamant cu frecventa redusa; invatamant la distanta', 0, 0, 'C');
    ...
    //                          III. Cerinte pt fac.  
	 ...
	 //Pagina 4
	  ...
	  $pdf->SetFont('Times','BI',10);
	  $pdf->Cell(65);
	  $pdf->MultiCell(60, 6, 'Ordinea preferintelor', 1, 1);
	 ...
	 if($diploma_echiv_studii_copie == 1) $raspuns_echiv_studii_copie = 'DA';
     ...
     $pdf->SetFont('Times','BI',10);
	 $pdf->Cell(57);
     $pdf->MultiCell(64, 6, 'Diploma de olimpiada (original)', 1, 1);
	 $pdf->SetXY($x + 121, $y);
     $pdf->SetFont('Times','B',8);
	 ...
	 $pdf->Cell(0,0,'V. CONDITII DE INCHEIERE A CONTRACTULUI',0,1);
	 $pdf->SetLineWidth(0);
