...
function Footer()
{
  ...
  //echo ''.$_POST['idFormular'];     
    ...
    $v_apartament = getApartament($v_idFormular);*/
	  ...
	  $pdf->Cell(10);
	  $pdf->MultiCell(120, 6, 'Popescu', 1, 1);
	  $pdf->SetXY($x + 150, $y);
	  $pdf->MultiCell(10, 6,'A.C.',1,  1);
	  ...
	  $pdf->SetXY($x + 82, $y);
	  $pdf->SetFont('Times','B',9);
	  $pdf->MultiCell(43, 12,'Elena',1,  1);
	  $pdf->SetXY($x + 125, $y);
	  $pdf->SetFont('Times','BI',10);
	  $pdf->MultiCell(12, 12,'Tata',1,  1);
	  $pdf->SetXY($x + 137, $y);
	  $pdf->SetFont('Times','B',9);
	  $pdf->MultiCell(43, 12,'Leonard',1,  1);
	  ...
	  $pdf->SetXY($x + 23, $y);
	  $pdf->SetFont('Times','B',9);
	  $pdf->MultiCell(90, 6,'19252521252525',1,  1);
	  $pdf->SetXY($x + 150, $y);
	  $pdf->SetFont('Times','BI',10);
	  ...
	  $pdf->SetFont('Times','B',9);
	  $pdf->Cell(50);
	  $pdf->MultiCell(30, 6,'15',1,  1);
	  $pdf->SetXY($x + 80, $y);
	  $pdf->MultiCell(30, 6,'11',1,  1);
	  $pdf->SetXY($x + 110, $y);
	  $pdf->MultiCell(30, 6,'1996',1,  1);
	  ...
	  $pdf->Cell(12);
	  $pdf->MultiCell(55, 6, 'Romania', 1, 1);
	  $pdf->SetXY($x + 67, $y);
	  $pdf->MultiCell(55, 6,'Alba',1,  1);
	  $pdf->SetXY($x + 122, $y);
	  $pdf->MultiCell(55, 6,'Stanca',1,  1);
	  ...
	  $pdf->MultiCell(40, 6, 'Cetatenia (tara)', 1, 1);
	  $pdf->SetXY($x + 55, $y);
	  $pdf->MultiCell(40, 6,'romana',1,  1);
	  $pdf->SetXY($x + 95, $y);
	  $pdf->MultiCell(40, 6,'rrom',1,  1);
	  $pdf->SetXY($x + 135, $y);
	  $pdf->MultiCell(40, 6,'romana',1,  1);
	  ...
	  $pdf->SetXY($x + 67, $y);
	  $pdf->MultiCell(55, 6,'AL',1,  1);
	  $pdf->SetXY($x + 122, $y);
	  $pdf->MultiCell(55, 6,'852122',1,  1);
	  ...
	  $pdf->Cell(15);
	  $pdf->MultiCell(70, 6, 'SPCLEP Alba Iulia', 1, 1);
	  $pdf->SetXY($x + 85, $y);
	  $pdf->MultiCell(30, 6,'15',1,  1);
	  $pdf->SetXY($x + 115, $y);
	  $pdf->MultiCell(30, 6,'11',1,  1);
	  ...
	  $pdf->MultiCell(95, 6, 'Vasile Cosbuc', 1, 1);
	  $pdf->SetXY($x + 120, $y);
	  $pdf->MultiCell(60, 6,'15',1,  1);
	 ...
	 $pdf->MultiCell(60, 6, 'Stanca', 1, 1);
	 $pdf->SetXY($x + 105, $y);
	 $pdf->MultiCell(60, 6,'Alba',1,  1);
	 ...
	 $pdf->MultiCell(60, 6, '515243', 1, 1);
	 $pdf->SetXY($x + 85, $y);
	 $pdf->MultiCell(70, 6,'Romania',1,  1);
	 ...
	 $pdf->MultiCell(50, 6, '0753542414', 1, 1);
	 $pdf->SetXY($x + 85, $y);
	 $pdf->MultiCell(95, 6,'popescuion@gmail.com',1,  1);
	 ...
	 $pdf->Cell(25);
	 $pdf->SetFont('Times','B',9);
	 $pdf->Cell(140,6,'Liceul teologic Alba Iulia',1,0,'C');
     ...
     $pdf->Cell(1);
	 $pdf->MultiCell(100, 6, 'informatica', 1, 1);
	 $pdf->SetXY($x + 101, $y);
