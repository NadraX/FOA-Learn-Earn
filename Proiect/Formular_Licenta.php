								...
								<div  class="form-input jf-required cid_1">
									...
									<div data-wrapper-react="true">
										...
										<span class="form-sub-label-container" style="vertical-align:top; width:24%;padding:0;margin:0;">
											...
											<input type="text" class="form-dropdown form-address-country liceu" name="Licenta_Judet_Nastere" data-component="country" list="JudetNastere" value='<?php  
																																														if(isset($_POST['Submit'])) {
																																															$v_Licenta_Judet_Nastere = $_POST["Licenta_Judet_Nastere"];
																																															echo $v_Licenta_Judet_Nastere;
																																														} 
																																													?>'>
											...
											<span style="color:red">
												<?php
													if(isset($_POST['Submit'])) {
														$v_Licenta_Judet_Nastere = $_POST["Licenta_Judet_Nastere"];
														$vLicenta_Judet_Nastere=validNume($v_Licenta_Judet_Nastere);
														if($vLicenta_Judet_Nastere==-1)
															echo "C&#226;mp necompletat!";
														else
															if($vLicenta_Judet_Nastere==1)
																echo "C&#226;mpul conține caractere nepermise!";
															else
																if($vLicenta_Judet_Nastere==2)
																	echo "C&#226;mpul trebuie sa conțină între 3 și 30 caractere!";
													}
												?>
											</span>
											...
											<tr>
												<td>
													...
													<span class="form-sub-label-container" style="vertical-align:top; width:24%">
														...
														<input type="text" class="form-dropdown form-address-country liceu" name="Licenta_Judet" data-component="country" list="JudetStabil" value='<?php  
																																														if(isset($_POST['Submit'])) {
																																															$v_Licenta_Judet = $_POST["Licenta_Judet"];
																																															echo $v_Licenta_Judet;
																																														} 
																																													?>'>
														...
														<span style="color:red">
															<?php
																if(isset($_POST['Submit'])) {
																	$v_Licenta_Judet = $_POST["Licenta_Judet"];
																	$vLicenta_Judet=validNume($v_Licenta_Judet);
																	if($vLicenta_Judet==-1)
																		echo "C&#226;mp necompletat!";
																	else
																		if($vLicenta_Judet==1)
									...
									<div>
										<span class="form-sub-label-container liceu" style="vertical-align:top; width:100%;">
											...
											<datalist id="licee">
												...
												<option value='Colegiul Economic "A.D. Xenopol" București'>Colegiul Economic "A.D. Xenopol" București</option>
												<option value='Colegiul Economic "Hermes" București'>Colegiul Economic "Hermes" București</option>
												<option value='Colegiul German "Goethe" București'>Colegiul German "Goethe" București</option>
												<option value='Colegiul Naţional "Aurel Vlaicu" București'>Colegiul Naţional "Aurel Vlaicu București"</option>
												<option value='Colegiul Naţional "Elena Cuza" București'>Colegiul Naţional "Elena Cuza" București</option>
												...
												<option value='Colegiul Naţional "Grigore Moisil" București'>Colegiul Naţional "Grigore Moisil" București</option>
												<option value='Colegiul Naţional "I.L. Caragiale" București'>Colegiul Naţional "I.L. Caragiale" București</option>
												<option value='Colegiul Naţional "Ion Creangă" București'>Colegiul Naţional "Ion Creangă" București</option>
												<option value='Colegiul Naţional "Ion Neculce" București'>Colegiul Naţional "Ion Neculce" București</option>
												<option value='Colegiul Național "Matei Basarab" București'>Colegiul Național "Matei Basarab" București</option>
												<option value='Colegiul Naţional "Mihai Eminescu" București'>Colegiul Naţional "Mihai Eminescu" București</option>
												<option value='Colegiul Naţional "Octav Onicescu" București'>Colegiul Naţional "Octav Onicescu" București</option>
												<option value='Colegiul Naţional "Sfântul Sava" București'>Colegiul Naţional "Sfântul Sava" București</option>
												<option value='Colegiul Național "Cantemir Vodă" București'>Colegiul Național "Cantemir Vodă" București</option>
												<option value='Colegiul Național "Emil Racoviță" București'>Colegiul Național "Emil Racoviță" București</option>
												<option value='Colegiul Național "Iulia Hașdeu" București'>Colegiul Național "Iulia Hașdeu" București</option>
												<option value='Colegiul Național "Mihai Viteazul" București'>Colegiul Național "Mihai Viteazul" București</option>
												<option value='Colegiul Național "Spiru Haret" București'>Colegiul Național "Spiru Haret" București</option>
												<option value='Colegiul Național "Victor Babeș" București'>Colegiul Național "Victor Babeș" București</option>
												<option value='Colegiul Național Bilingv "George Coșbuc" București'>Colegiul Național Bilingv "George Coșbuc" București</option>
												<option value='Colegiul Naţional de Arte "Dinu Lipatti" București'>Colegiul Naţional de Arte "Dinu Lipatti" București</option>
												<option value='Colegiul Naţional de Informatică "Tudor Vianu" București'>Colegiul Naţional de Informatică "Tudor Vianu" București</option>
												<option value='Colegiul Naţional de Muzică "George Enescu" București'>Colegiul Naţional de Muzică "George Enescu" București</option>
												<option value='Colegiul Romano-Catolic "Sfântul Iosif" București'>Colegiul Romano-Catolic "Sfântul Iosif" București</option>
												<option value='Colegiul Tehnic "Anghel Saligny" București'>Colegiul Tehnic "Anghel Saligny" București</option>
												...
												<option value='Colegiul Tehnic "Dinicu Golescu" București'>Colegiul Tehnic "Dinicu Golescu" București</option>
												<option value='Colegiul Tehnic "Gheorghe Asachi" București'>Colegiul Tehnic "Gheorghe Asachi" București</option>
												<option value='Colegiul Tehnic "Iuliu Maniu" București'>Colegiul Tehnic "Iuliu Maniu" București</option>
												<option value='Colegiul Tehnic "Media"'>Colegiul Tehnic "Media"</option>
												<option value='Colegiul Tehnic "Mihai Bravu" București'>Colegiul Tehnic "Mihai Bravu" București</option>
												<option value='Colegiul Tehnic "Mircea cel Bătrân" București'>Colegiul Tehnic "Mircea cel Bătrân" București</option>
												<option value='Colegiul Tehnic "Miron Nicolescu" București'>Colegiul Tehnic "Miron Nicolescu" București</option>
												<option value='Colegiul Tehnic "Petru Maior" București'>Colegiul Tehnic "Petru Maior" București</option>
												<option value='Colegiul Tehnic "Dimitrie Leonida" București'>Colegiul Tehnic "Dimitrie Leonida" București</option>
												<option value='Colegiul Tehnic "Edmond Nicolau" București'>Colegiul Tehnic "Edmond Nicolau" București</option>
												<option value='Colegiul Tehnic "Petru Rareș" București'>Colegiul Tehnic "Petru Rareș" București</option>
												<option value='Colegiul Tehnic de Aeronautică "Henri Coandă" București'>Colegiul Tehnic de Aeronautică "Henri Coandă" București</option>
												<option value='Colegiul Tehnic de Arhitectură Şi Lucrări Publice "Ioan N. Socolescu" București'>Colegiul Tehnic de Arhitectură Şi Lucrări Publice "Ioan N. Socolescu" București</option>
												<option value='Colegiul Tehnic de Industrie Alimentară "Dumitru Moţoc" București'>Colegiul Tehnic de Industrie Alimentară "Dumitru Moţoc" București</option>
												<option value='Colegiul Tehnic de Poştă și Telecomunicaţii "Gheorghe Airinei" București'>Colegiul Tehnic de Poştă și Telecomunicaţii "Gheorghe Airinei" București</option>
												<option value='Colegiul Tehnic Energetic'>Colegiul Tehnic Energetic</option>
												<option value='Colegiul Tehnic Feroviar "Mihai I" București'>Colegiul Tehnic Feroviar "Mihai I" București</option>
												<option value='Colegiul Tehnic Mecanic "Griviţa" București'>Colegiul Tehnic Mecanic "Griviţa" București</option>
												<option value='Colegiul Tehnologic "Grigore Cerchez" București'>Colegiul Tehnologic "Grigore Cerchez" București</option>
												<option value='Colegiul Tehnologic "Viaceslav Harnaj" București'>Colegiul Tehnologic "Viaceslav Harnaj" București</option>
												<option value='Liceul "Dimitrie Paciurea" București'>Liceul "Dimitrie Paciurea" București</option>
												<option value='Liceul cu Program Sportiv "Mircea Eliade" București'>Liceul cu Program Sportiv "Mircea Eliade" București</option>
												<option value='Liceul de Arte Plastice "Nicolae Tonitza" București'>Liceul de Arte Plastice "Nicolae Tonitza" București</option>
												<option value='Liceul de Coregrafie "Floria Capsali" București'>Liceul de Coregrafie "Floria Capsali" București</option>
												<option value='Liceul Greco-Catolic "Timotei Cipariu" București'>Liceul Greco-Catolic "Timotei Cipariu" București</option>
												<option value='Liceul Tehnologic "Dacia" București'>Liceul Tehnologic "Dacia" București</option>
												<option value='Liceul Tehnologic "Dimitrie Gusti" București'>Liceul Tehnologic "Dimitrie Gusti" București</option>
												<option value='Liceul Tehnologic "Dragomir Hurmuzescu" București'>Liceul Tehnologic "Dragomir Hurmuzescu" București</option>
												<option value='Liceul Tehnologic "Elie Radu" București'>Liceul Tehnologic "Elie Radu" București</option>
												<option value='Liceul Tehnologic "Ion I.C. Brătianu" București'>Liceul Tehnologic "Ion I.C. Brătianu" București</option>
												<option value='Liceul Tehnologic "Mircea Vulcănescu" București'>Liceul Tehnologic "Mircea Vulcănescu" București</option>
												<option value='Liceul Tehnologic "Petru Poni" București'>Liceul Tehnologic "Petru Poni" București</option>
												<option value='Liceul Tehnologic "Sf. Antim Ivireanu" București'>Liceul Tehnologic "Sf. Antim Ivireanu" București</option>
												<option value='Liceul Tehnologic "Constantin Brâncuși" București'>Liceul Tehnologic "Constantin Brâncuși" București</option>
												<option value='Liceul Tehnologic "Electronica Industrială" București'>Liceul Tehnologic "Electronica Industrială" București</option>
												<option value='Liceul Tehnologic "Sfântul Pantelimon" București'>Liceul Tehnologic "Sfântul Pantelimon" București</option>
												<option value='Liceul Tehnologic de Metrologie "Traian Vuia" București'>Liceul Tehnologic de Metrologie "Traian Vuia" București</option>
												<option value='Liceul Tehnologic Theodor Pallady'>Liceul Tehnologic Theodor Pallady</option>
												<option value='Liceul Teologic Adventist "Ştefan Demetrescu" București'>Liceul Teologic Adventist "Ştefan Demetrescu" București</option>
												<option value='Liceul Teologic Baptist "Logos" București'>Liceul Teologic Baptist "Logos" București</option>
												<option value='Liceul Teologic Penticostal "Emanuel"'>Liceul Teologic Penticostal "Emanuel"</option>
												<option value='Liceul Teoretic "Alexandru Ioan Cuza" București'>Liceul Teoretic "Alexandru Ioan Cuza" București</option>
												<option value='Liceul Teoretic "Alexandru Vlahuţă" București'>Liceul Teoretic "Alexandru Vlahuţă București"</option>
												<option value='Liceul Teoretic "Benjamin Franklin" București'>Liceul Teoretic "Benjamin Franklin" București</option>
												<option value='Liceul Teoretic "Constantin Brâncoveanu" București'>Liceul Teoretic "Constantin Brâncoveanu" București</option>
												<option value='Liceul Teoretic "Dante Alighieri" București'>Liceul Teoretic "Dante Alighieri" București</option>
												<option value='Liceul Teoretic "Decebal" București'>Liceul Teoretic "Decebal" București</option>
												<option value='Liceul Teoretic "Dimitrie Bolintineanu" București'>Liceul Teoretic "Dimitrie Bolintineanu" București</option>
												<option value='Liceul Teoretic "Eugen Lovinescu" București'>Liceul Teoretic "Eugen Lovinescu" București</option>
												<option value='Liceul Teoretic "George Călinescu" București'>Liceul Teoretic "George Călinescu" București</option>
												<option value='Liceul Teoretic "Ion Barbu" București'>Liceul Teoretic "Ion Barbu" București</option>
												<option value='Liceul Teoretic "Jean Monnet" București'>Liceul Teoretic "Jean Monnet" București</option>
												<option value='Liceul Teoretic "Marin Preda" București'>Liceul Teoretic "Marin Preda" București</option>
												<option value='Liceul Teoretic "Nichita Stănescu" București'>Liceul Teoretic "Nichita Stănescu" București</option>
												<option value='Liceul Teoretic "Nicolae Iorga" București'>Liceul Teoretic "Nicolae Iorga București"</option>
												<option value='Liceul Teoretic "Ștefan Odobleja"'>Liceul Teoretic "Ștefan Odobleja"</option>
												<option value='Liceul Teoretic "Tudor Vladimirescu" București'>Liceul Teoretic "Tudor Vladimirescu" București</option>
												<option value='Liceul Teoretic "Ady Endre" București'>Liceul Teoretic "Ady Endre" București</option>
												<option value='Liceul Teoretic "C.A. Rosetti" București'>Liceul Teoretic "C.A. Rosetti" București</option>
												<option value='Liceul Teoretic "Lucian Blaga" București'>Liceul Teoretic "Lucian Blaga" București</option>
												<option value='Liceul Teoretic "Mihail Sadoveanu" București'>Liceul Teoretic "Mihail Sadoveanu" București</option>
												<option value='Liceul Teoretic "Traian" București'>Liceul Teoretic "Traian" București</option>
												<option value='Liceul Teoretic Bilingv "Miguel de Cervantes" București'>Liceul Teoretic Bilingv "Miguel de Cervantes București"</option>
												<option value='Liceul Teoretic Bilingv "Ita Wegman" București'>Liceul Teoretic Bilingv "Ita Wegman" București</option>
												<option value='Liceul Teoretic Bulgar "Hristo Botev" București'>Liceul Teoretic Bulgar "Hristo Botev" București</option>
												<option value='Liceul Teoretic Waldorf București'>Liceul Teoretic Waldorf București</option>
												<option value='Școala Centrală București'>Școala Centrală București</option>
												<option value='Școala Superioară Comercială "Nicolae Kretzulescu" București'>Școala Superioară Comercială "Nicolae Kretzulescu" București</option>
												...
												<option value='LICEUL TEHNOLOGIC "HENRI COANDĂ" București'>LICEUL TEHNOLOGIC "HENRI COANDĂ" București</option>
											...
											<tr>
												<td>
													...
													<span class="form-sub-label-container" style="vertical-align:top; width:32%">
														<label class="form-sub-label" for="input_3_country" style="min-height:13px;"> Jude&#355; </label>
														<input type="text" class="form-dropdown form-address-country liceu" name="Licenta_Judet_Liceu" data-component="country" list="JudetLicenta" value='<?php  
																																														if(isset($_POST['Submit'])) {
																																															$v_Licenta_Judet_Liceu = $_POST["Licenta_Judet_Liceu"];
																																															echo $v_Licenta_Judet_Liceu;
																																														} 
																																													?>'>
														<datalist id="JudetLicenta" >
														<?php
																$array=array("Alba","Arad","Argeș","Bacău","Bihor","Bistrița-Năsăud","Botoșani","Brăila","Brașov","București","Buzău","Călărași","Caraș-Severin","Cluj","Constanța","Covasna","Dâmbovița","Galați","Giurgiu","Gorj","Harghita","Hunedoara","Ialomița","Iași","Ilfov","Maramureș","Mehedinți","Mureș","Neamț","Olt","Prahova","Sălaj","Satu Mare","Sibiu","Suceava","Teleorman","Timișoara","Tulcea","Vâlcea","Vaslui","Vrancea","Bălți","Cahul","Chișinău","Edineț","Găgăuzia","Lăpușna","Orhei","Taraclia","Tighina","Ungheni","Soroca");
																for($i=0;$i<52;$i++)
																{
														...
														<span style="color:red">
															<?php
																if(isset($_POST['Submit'])) {
																	$v_Licenta_Judet_Liceu = $_POST["Licenta_Judet_Liceu"];
																	$vLicenta_Judet_Liceu=validNume($v_Licenta_Judet_Liceu);
																	if($vLicenta_Judet_Liceu==-1)
																		echo "C&#226;mp necompletat!";
																	else
																		if($vLicenta_Judet_Liceu==1)
																			echo "C&#226;mpul conține caractere nepermise!";
																		else
																			if($vLicenta_Judet_Liceu==2)
																				echo "C&#226;mpul trebuie sa conțină între 3 și 30 caractere!";
																}
															?>
														</span>
												...
												<tr>
													<td>
														...
														<span class="form-sub-label-container" style="vertical-align:top; width:32%">
															...
															<input type="text" class="form-dropdown form-address-country liceu" name="Licenta_Judet_AltaFacultate" data-component="country" list="JudetAltaFacultate" value='<?php  
																																														if(isset($_POST['Submit'])) {
																																															$v_Licenta_Judet_AltaFacultate = $_POST["Licenta_Judet_AltaFacultate"];
																																															echo $v_Licenta_Judet_AltaFacultate;
																																														} 
																																													?>'>
											...
											<tbody>
												<tr>
													<td>
														...
														<span class="form-sub-label-container" style="vertical-align:top; width:32%">
															<label class="form-sub-label" for="input_3_country" style="min-height:13px;"> Jude&#355; </label>
															<input type="text" class="form-dropdown form-address-country liceu" name="Licenta_AbsolventLicenta_Judet_AltaFacultate" data-component="country" list="JudetLicentaAbsolvita" value='<?php  
																																														if(isset($_POST['Submit'])) {
																																															$v_Licenta_AbsolventLicenta_Judet_AltaFacultate = $_POST["Licenta_AbsolventLicenta_Judet_AltaFacultate"];
																																															echo $v_Licenta_AbsolventLicenta_Judet_AltaFacultate;
																																														} 
																																													?>'>
															<datalist id="JudetLicentaAbsolvita" >
															<?php
																	$array=array("Alba","Arad","Argeș","Bacău","Bihor","Bistrița-Năsăud","Botoșani","Brăila","Brașov","București","Buzău","Călărași","Caraș-Severin","Cluj","Constanța","Covasna","Dâmbovița","Galați","Giurgiu","Gorj","Harghita","Hunedoara","Ialomița","Iași","Ilfov","Maramureș","Mehedinți","Mureș","Neamț","Olt","Prahova","Sălaj","Satu Mare","Sibiu","Suceava","Teleorman","Timișoara","Tulcea","Vâlcea","Vaslui","Vrancea","Bălți","Cahul","Chișinău","Edineț","Găgăuzia","Lăpușna","Orhei","Taraclia","Tighina","Ungheni","Soroca");
																	for($i=0;$i<52;$i++)
																	{
      ...
      echo "Connection failed. Please try again";
		...
		$vradio35 = validRadioFinal($v_Radio35);
			...
			if($v_Radio25 == 1) 
			{
				...
				$v_Licenta_Semestre_Finantate = $_POST["Licenta_Semestre_Finantate"];
				$v_Licenta_Semestre_Bursa = $_POST["Licenta_Semestre_Bursa"];
				if(($v_Licenta_Semestre_Bursa >= 0 && $v_Licenta_Semestre_Bursa <= 16) && ($v_Licenta_Semestre_Finantate >= 0 && $v_Licenta_Semestre_Finantate <= 16) && $vLicentaAnFacultate == 0 && $vLicentaSpecializare == 0 && $vLicentaDomeniuLicenta == 0 && $vLicenta_AltaFacultate == 0 && $vLicenta_AltaUniversitate == 0 && $vLicenta_Localitate_AltaFacultate == 0) $v_verificare_radio_25 = 1;
			...
			if($v_Radio23 == 1)
			{
				...
				if($vLicenta_Serie_DiplomaLicenta == 0 && ctype_digit($v_Licenta_Nr_DiplomaLicenta)) $v_verificare_radio_23 = 1;
			...
			if($v_Radio24 == 1)
			{
				...
				if($vLicenta_AbsolventLicenta_Anul_Absolvirii == 0 && $vLicenta_AbsolventLicenta_Localitate_AltaFacultate == 0 && ($v_Licenta_AbsolventLicenta_Semestre_Bursa >= 0 && $v_Licenta_AbsolventLicenta_Semestre_Bursa <= 16) && ($v_Licenta_AbsolventLicenta_Semestre_Finantate >= 0 && $v_Licenta_AbsolventLicenta_Semestre_Finantate <= 16) && $vLicenta_AbsolventLicenta_Durata_Studii == 0 && $vLicenta_AbsolventLicenta_An_Facultate == 0 && $vLicenta_AbsolventLicenta_Specializare == 0 && $vLicenta_AbsolventLicenta_Domeniu_Licenta == 0 && $vLicenta_AbsolventLicenta_Facultate == 0 & $vLicenta_AbsolventLicenta_Univ == 0 && (($v_Radio23 == 1 && $v_verificare_radio_23 == 1) || $v_Radio23 == 2)) $v_verificare_radio_24 = 1;
