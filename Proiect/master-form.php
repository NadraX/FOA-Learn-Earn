								...
								<div  class="form-input jf-required cid_1">
									...
									<div data-wrapper-react="true">
										...
										<span  class="form-sub-label-container" style="vertical-align:top; width:6%;padding:0;margin:0;">
										  ...
										  <input type="text" name="Master_Tip_Buletin" class="form-textbox first_1" size="20" placeholder="ex: C.I. / CI" data-component="first" value="<?php 
...
<option value="LICEUL &quot;SIMION MEHEDINŢI&quot; VIDRA">
									...
									<label class="form-sub-label" style="min-height:13px;">Liceul absolvit</label>
								...
								<div>
									...
									<span class="form-sub-label-container liceu" style="vertical-align:top; width:100%;">
										...
										<select  class="form-dropdown form-address-country liceu" name="Universitatea_absolvita">

											<option value="UNIVERSITATEA ALEXANDRU IOAN CUZA DIN IASI">Universitatea "Alexandru Ioan Cuza" din Ia&#351;i</option>

											<option value="UNIVERSITATEA TEHNICA GHEORGHE ASACHI DIN IASI">Universitatea Tehnic&#259; Gheorghe Asachi din Ia&#351;i</option>
									...
									<label class="form-sub-label" style="min-height:13px;">Universitatea pe care a&#355;i absolvit-o</label>
								...
								<div class="form-input jf-required cid_1" >
									...
									<div data-wrapper-react="true" class="mg">
										...
										<span class="form-sub-label-container" style="vertical-align:top; width:100%" >
											...
											<input type="text"  name="Master_Medie_BAC"  class="form-textbox first_1"  size="20" data-component="first"  value="<?php 
											...
											<label class="form-sub-label" style="min-height:13px;">Media general&#259; Bacalaureat</label>
									...
									<div class="mg">
										...
										<span class="form-sub-label-container gen" style="vertical-align:top;">
											...
											<label class="form-sub-label" style="min-height:13px;">Doresc &#238;nva&#355;&#259;m&#226;nt de zi</label>
												...
												<tr>
													...
													<td>
														...
														<span class="form-sub-label-container" style="vertical-align:top; width:44%">
															...
															<label class="form-sub-label" style="min-height:13px;">Strada </label>
												...
												<tr>
													...
													<td>
														...
														<span class="form-sub-label-container" style="vertical-align:top; width:24%">
															...
															<label class="form-sub-label" style="min-height:13px;"> Localitate </label>
														...
														<span class="form-sub-label-container" style="vertical-align:top; width:24%">
														   ...
														   <select class="form-dropdown form-address-country gen" name="Master_Judet" data-component="judet">
															...
															<label class="form-sub-label" style="min-height:13px;"> Jude&#355; </label>
														...
														<span class="form-sub-label-container" style="vertical-align:top; width:24%">
															...
															<label class="form-sub-label" style="min-height:13px;"> Cod po&#351;tal</label>
									...
									<div id="cid_6" class="form-input jf-required" style="width:100%">
										...
										<div data-wrapper-react="true" style="width:100%">
											...
											<span class="form-sub-label-container" style="vertical-align:top; width:100%">
												...
												<input name="Master_Telefon" class="form-textbox" size="20" placeholder="ex: 0751404400"  data-component="phone"  style="width:100%; height:40px" value="<?php 
												...
												<label class="form-sub-label"  style="min-height:13px;"> Num&#259;r de telefon </label>
										...
										<div data-wrapper-react="true">
											...
											<span class="form-sub-label-container" style="vertical-align:top; width:100%">
												...
												<input type="email"  name="Master_Email" class="form-textbox validate[Email]" size="30" placeholder="ex: adresamea@yahoo.com" data-component="email" style="width:100%;height:40px" value="<?php 
																																																															if($v_Licenta_Email == '') 
																																																																echo '';
																																																															else
												...
												<label class="form-sub-label"  style="min-height:13px;"> E-mail </label>
