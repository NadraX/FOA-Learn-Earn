...
function validareNumar($p_numar)
    {
        ...
        return 1;//contine caractere incorecte
    }
...
//fct buna
    function validareBloc($p_bloc)
    {
        ...
        if($p_bloc=='-')
            return 0;
        if (!ctype_alpha(str_replace(' ','',str_replace('-', '', $p_prenume)))  && !ctype_digit(str_replace(' ','',str_replace('-', '', $p_prenume))))
            return 1; // caractere incorecte
...
//fct buna
    function validareEtaj($p_etaj)
    {
        ...
        if(!ctype_digit($p_etaj))
            return 1; //caractere interzise
        
        if($p_etaj < -1 || $p_etaj > 163)
