		...
		<div class="col-sm-3"></div>
			<div class="col-sm-6">
			  <div class="w3-card-4 w3-round">
				  <div class="w3-container w3-win-metro-dark-blue w3-round">
					<h2><center><img src="imagini/graduation-hat.png" alt="licenta" height="50" width="130"></center></h2>
				  </div>
				  <form class="w3-container" action="/action_page.php">
					<br />
					<div class="w3-row w3-section">
					  <div class="w3-col w3-container" style="width:50px"><i class="w3-xxlarge fa fa-user-circle-o"></i></div>
					  <div class="w3-rest w3-container"><input class="w3-input w3-border w3-round w3-win-metro-light-blue " placeholder="Nume" name="nume" type="text">	</div>
					</div>
					<div class="w3-row">
					  <div class="w3-col w3-container" style="width:50px"><i class="w3-xxlarge glyphicon glyphicon-lock"></i></div>
					  <div class="w3-rest w3-container"><input class="w3-input w3-border w3-round w3-win-metro-light-blue" placeholder="Parola" name="parol&#259" type="password"></div>
					</div>
					<p>
						<center><button class="w3-btn w3-round w3-win-metro-dark-blue w3-margin-top"><b>Logheaz&#259-m&#259</b></button><center>
					</p>
				  </form>
			  </div>
			</div>
